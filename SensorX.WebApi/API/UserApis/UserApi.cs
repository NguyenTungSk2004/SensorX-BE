using SensorX.Application.Commands.UserModule.Login;
using SensorX.Application.Commands.UserModule.SignUpWithLocalAccount;
using SensorX.Application.Commands.UserModule.UpdateProfile;
using SensorX.Application.Commands.UserModule.VerifyToken;
using SensorX.Application.Common.ResponseClient;
using MediatR;
using Microsoft.AspNetCore.Http.HttpResults;
using Microsoft.AspNetCore.Mvc;
using SensorX.WebApi.API.UserApis.Request;

namespace SensorX.WebApi.API.UserApis
{
